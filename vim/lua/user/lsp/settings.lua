...
M.flags = {
  debounce_text_changes = globals.buffer_upd_time,
}
...
function M.get_capabilities()
  ...
  local cmp_installed = requ.installed("cmp_nvim_lsp")
...
function M.setup_servers()
  local lsp_installer_installed = requ.installed("nvim-lsp-installer")
